...
namespace DAL
{
    public class Dal_imp : Idal
    {
       ...
       public IEnumerable<BE.Trainee> getAllTrainees(Func<BE.Tester, bool> predicat = null)
        {//נבחנים
       ...
       public  IEnumerable<BE.Test> getAllTests(Func<BE.Tester, bool> predicat = null)
        {
